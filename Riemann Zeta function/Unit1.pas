...
uses
  ...
  ExtCtrls, complexm, ComCtrls, StdCtrls, math, XPMan;
...
// Subsequent solution of gamma tester
{---------------------------------------------------------------------------}
...
procedure zetacrit(t: extended; var re,im: extended);
  {-Calculate  re + i*im = Zeta(1/2 + i*t) with Riemann seal}
const
  m=2;  {The maximum order of the correction terms must be <= 4.}
var
  i,n: longint;
  axx,axy: extended;

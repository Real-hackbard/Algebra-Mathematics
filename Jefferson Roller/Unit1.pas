...
begin
  ...
  if (length(scheibenreihenfolge)<>jeffscheiben) or
      (not scheibentest(scheibenreihenfolge)) then begin
  ...
  can.textout(xoff,40-can.textheight(k) div 2,'Entrance');
  can.textout(xoff,h-40-can.textheight(k) div 2,'Exit');
  codes.free;
end;
...
begin
  ...
  button2.caption:='Encode Message';
  phabbruch:=true;
end;
...
begin
  ...
  button3.caption:='Decode Message';
  phabbruch:=true;
end;

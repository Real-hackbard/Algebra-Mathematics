...
uses
  ...
  StdCtrls, Buttons, Menus, Spin, Mask, math, ExtCtrls, XPman, Dialogs;
...
const
    farben1 : array[0..5,1..3] of integer
            = ((100,104,0),(147,156,3),
              (206,204,0),(255,253,8),(255,255,98),(254,254,154));
    farben2 : array[0..6,1..3] of integer
            = ((47,104,1),(104,202,3),
              (97,211,28),(162,252,43),(150,250,117),(200,254,114),
               (210,250,164));
    farben3 : array[0..6,1..3] of integer
            = ((48,1,105),(103,0,203),
              (101,51,208),(155,49,255),(155,101,255),(202,105,247),
               (211,150,254));
...
begin
  ...
  begin
    try
      ...
      Bitmap.Width:= Spin2.Value;
      Bitmap.Height:= Spin3.Value;

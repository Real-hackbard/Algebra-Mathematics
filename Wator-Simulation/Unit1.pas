...
uses
  ...
  Menus, Buttons, ComCtrls, ExtCtrls, StdCtrls, XPMan;
      ...
      for j:=0 to 74 do begin
        ...
        zelle[i,j].ch:=0;
            ...
            for i:=1 to game do
              ...
              Label7.caption:='Chronons '+inttostr(chronon);
              Label5.caption:='Playing Field '+inttostr(game);
              label1.caption:='Fish '+inttostr(anzahl_fisch);
              label2.caption:='Sharks '+inttostr(anzahl_hai);
...
procedure TForm1.E10C(Sender: TObject);
begin
    pf:=ein_int(Edit3);
    if pf<1 then pf:=50;
    ph:=ein_int(Edit4);

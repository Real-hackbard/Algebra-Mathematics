      ...
      object panel1: TPanel
        ...
        object Liste: TListBox
          ...
          Items.Strings = (
            ...
            '4-8-8'#9'abridged square'
            '3-12-12'#9'stepped hexagonal'
            ...
            '3-3-3-3-6'#9'abbreviated hexagonal'
            '3-3-3-4-4'#9'expands trigonally'
            '3-3-4-3-4'#9'abgeschr.quadratisch'
            '3-3-4-3-4 B'#9'abbreviated square'
            '3-3-4-3-4 C'#9'abbreviated square'
            '3.3.3.3.6'#9'pentagonal'
            '3.6.3.6'#9'rhombic'
            '4.6.12'#9'halved hexagonally'
            '3.4.6.4'#9'deltoidal trihexagonal'
            '4.8.8'#9'Tetrakis square'
            '3.4.4'#9'rectangular'
            '3.3.4'#9'cairo-pentagonal'
            '3.12.12'#9'triakis-trigonal'
            '3.3.4.4'#9'primatic-pentagonal')
          TabOrder = 0
          TabWidth = 43
          OnClick = pa1P
        end

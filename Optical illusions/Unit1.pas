...
uses
  ...
  StdCtrls, ExtCtrls, ComCtrls, XPman, Spin;
...
begin
    ...
    bitmap.canvas.Ellipse(round(b-t*f),
                          round(h+r/2-t),round(b+t*f+1),round(h+r/2+t+1));

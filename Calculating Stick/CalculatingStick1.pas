...
begin
    ...
    if v=0 then text(46+x,115,'Scale C')
           else text(46+x,115,'Scale D');
...
begin
    if rg1.itemindex=1 then
    begin
      sg1.cells[0,1]:='upper unit';
      sg1.cells[0,2]:='lower unit';
    end
    else
    begin
      sg1.cells[0,1]:='upper zero';
      sg1.cells[0,2]:='lower zero';
    end;
...
begin
      gedrueckt := false;
      gedruecktlaufer := false;
      sg1.cells[1,0]:='upper scale';
      sg1.cells[2,0]:='lower scale';
      sg1.cells[0,3]:='runner';

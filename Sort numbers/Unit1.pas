...
begin
  ...
  QueryPerformanceFrequency (f);      // Frequency of the counter
  QueryPerformanceCounter (t1);       // Counter reading 1
  ...
  QueryPerformanceCounter (t2);       // Counter reading 2
  lblTime.Caption := FormatFloat ('Sortierzeit: 0.0 ms', 1000*(t2-t1)/f);
  lblCompare.Caption := IntToStr (vergleich) + ' Comparisons';
  lblExchange.Caption := IntToStr (tausch) + ' Barter operations';
  ...
  lblCompare2.Caption := IntToStr (vergleich) + ' Comparisons';
  lblExchange2.Caption := IntToStr (tausch) + ' Barter operations';

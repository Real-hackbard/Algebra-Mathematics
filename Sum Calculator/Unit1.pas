...
uses
  ...
  Vcl.ComCtrls, Vcl.Shell.ShellCtrls, Vcl.StdCtrls, Vcl.CheckLst, Vcl.ExtCtrls;
...
procedure TForm1.b_neuClick(Sender: TObject);
begin
   randomize;
...
procedure TForm1.b_loesungClick(Sender: TObject);
...
begin
    ...
    begin
      sabbruch:=true;
      b_loesung.caption:='Problem solving';
    end
    else
    begin
      ...
      sabbruch:=true;
      panel3.caption:=inttostr(elistbox.items.count)+' Solutions';
      b_loesung.caption:='Problem solving';
      ...
      if zeit<1 then
        label1.caption:='Time '+floattostrf(1000*zeit,ffgeneral,4,3)+' ms'
      else
        label1.caption:='Time '+floattostrf(zeit,ffgeneral,4,3)+' s';
...
procedure TForm1.b_speichern(Sender: TObject);
begin
    if savedialog1.execute then elistbox.items.savetofile(savedialog1.filename);
end;

procedure TForm1.b_zieleClick(Sender: TObject);
var  zahl:array[2..9] of _zahl;
...
begin
    ...
    begin
      sabbruch:=true;
      b_ziele.caption:='Find Destination';
    end
    else
    begin
      elistbox.clear;
      ...
      sabbruch:=true;
      panel3.caption:=inttostr(elistbox.items.count)+' Entries';

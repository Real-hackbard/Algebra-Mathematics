...
uses
  ...
  StdCtrls, ExtCtrls, Buttons, ComCtrls, math, ShellApi, XPMan;
{$J+}
...
begin
    ...
    ziel.font.size:=8;
    ziel.textout(bb6+radius div 2+1,bh2+radius-16,'Tendons');
    ziel.textout(bb6+bb3+radius div 2+1,bh2+radius-16,'Tendons');
    ziel.textout(bb6+2*bb3+radius div 2+1,bh2+radius-16,'Tendons');

    ziel.textout(bb6+radius div 2+2,3*bh2+radius-16,'Midpoints');
    ziel.textout(bb6+bb3+radius div 2+2,3*bh2+radius-16,'Midpoints');
    ziel.textout(bb6+2*bb3+radius div 2+2,3*bh2+radius-16,'Midpoints');
...
begin
  if shellexecute(handle,'open','https://en.wikipedia.org/wiki/Bertrand_paradox_(probability)',nil,nil,sw_show)<=32

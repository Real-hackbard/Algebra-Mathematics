...
uses
  ...
  StdCtrls, ComCtrls, ExtCtrls, math, XPMan;
...
begin
    ...
    begin
      ...
      // Find the minimum of the rotated polygon
      if i<>361 then
    ...
    // Transform polygon points to window coordinates

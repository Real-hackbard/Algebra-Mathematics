...
uses
  ...
  Buttons, Menus, ExtCtrls, StdCtrls, CheckLst, Grids, XPMan;
...
const
  xwi=2.4E-01;  //2.64346095279206E-01;
  bwi=18.0;     //14.0
var
  wi:double;
  x,y:integer;
...
procedure TForm1.PB8P(Sender: TObject);
const
  rr=21;
var
  bitmap:tbitmap;
...
begin
  ...
  if (length(ka)*length(kb)>0) then begin
    ...
    if (length(a)<10) and (length(b)<10) then begin
      ...
      ziel.textout(-6*rr+offset-30,z+75,'Result = ');
      ...
      ziel.font.style:=[];
      ziel.textout(-2*rr+offset-30,z-20,'Carry');
      ziel.textout(-6*rr+offset-30,z+50,'Total decimal places = '+inttostr(ksa+ksb));
    end;
  end;
...
begin
  case rg1.itemindex of
    0 : begin
          l41.caption:='Written multiplication of two numbers';
          e57.text:='145,8';
          e58.text:='14,03';
        end;
   else begin
          l41.caption:='Long division of two natural numbers';
          e57.text:='1458';
          e58.text:='143';
        end;
  end;

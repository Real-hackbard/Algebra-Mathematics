...
// global sizes, otherwise stack overflow
const
    laenge=2000;
    siebgroesse=250000;
    panz=400000;
...
begin
      ...
      // Checking for gaps not yet found
      repeat
        diff:=k-i;
...
begin
    ...
    QueryPerformanceCounter(Time1);
      ...
      // First run with new z1, z2, z3
      // Determine the maximum sieve count
      grenze:=trunc(sqrt(1.0*(z+siebgroesse))+1);
      // Abort if the field is exceeded
      ...
      // Find three prime numbers in a sieve
      z1:=1;
    ...
    //=============================================================
    // main loop
    // search for lonely prime numbers
    repeat
      // Checking for gaps not yet found
      repeat
        diff:=z3-z1;
      ...
      z1:=z1-siebgroesse;
      z2:=z2-siebgroesse;
      // next range of 5 million numbers
      z:=z+siebgroesse;
